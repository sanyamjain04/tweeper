    ...
    <div className='flex flex-col items-center gap-6'>
      ...
      >
        <div className='grid grid-cols-[auto,1fr] gap-3'>
          <UserAvatar src='/assets/twitter-avatar.png' alt='Twitter' />
          <div>
            <div className='flex gap-1'>
              <UserName verified name='Twipper' />
              <p className='text-light-secondary dark:text-dark-secondary'>
                @twipper
              </p>
            ...
            <p className='whitespace-pre-line break-words'>
              At the heart of Twipper are short messages called Tweets — just
              like this one — which can include photos, videos, links, text,
              hashtags, and mentions like{' '}
              <span className='text-main-accent'>@twipper</span>.
            </p>
          </div>
        </div>
      </article>
